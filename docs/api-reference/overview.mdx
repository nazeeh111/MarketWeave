...
([`openapi.yaml`](https://github.com/nazeeh111/MarketWeave/blob/main/core/src/server/openapi.yaml))
generated from the TypeScript source of
[`BaseExchange.ts`](https://github.com/nazeeh111/MarketWeave/blob/main/core/src/exchanges/BaseExchange.ts)
