...
- Python source: [`sdks/python/pmxt/_hosted_errors.py`](https://github.com/nazeeh111/MarketWeave/blob/main/sdks/python/pmxt/_hosted_errors.py)
- TypeScript source: [`sdks/typescript/pmxt/hosted-errors.ts`](https://github.com/nazeeh111/MarketWeave/blob/main/sdks/typescript/pmxt/hosted-errors.ts)
