...
| Kalshi, Smarkets, Probable, Myriad, Metaculus, etc. | No | Read-only via catalog | Use [self-hosted](/guides/self-hosted) for venue-native writes where supported; check [Feature Support & Compliance](https://github.com/nazeeh111/MarketWeave/blob/main/core/COMPLIANCE.md) |
