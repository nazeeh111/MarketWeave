...
<Info>
Hosted writes today: **Polymarket**, **Opinion**, and **Limitless**. Other venues are read-only via the hosted catalog; use [self-hosted](/guides/self-hosted) for venue-native trading where the venue exposes writes. Check [Feature Support & Compliance](https://github.com/nazeeh111/MarketWeave/blob/main/core/COMPLIANCE.md) for per-venue support.
</Info>
