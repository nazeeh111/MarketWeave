/**
 * Advanced Filtering Examples for pmxtjs (TypeScript SDK)
 *
 * Demonstrates the powerful filtering capabilities for markets and events.
 */
...
async function main() {
    ...
    console.log('=== pmxtjs Advanced Filtering Examples ===\n');
